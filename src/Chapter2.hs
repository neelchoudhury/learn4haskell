...
-- We could also use res = subList 0 halfLen l
...
A - The number of bits in the Binary Representation of that number
...
-}
-- Assuming Negative numbres will not be present in the Input Array
-- If they appear, they will be ignored

smartReplicate :: [Int] -> [Int]
smartReplicate arr = concat (map (\x -> (replicate x x)) arr)
